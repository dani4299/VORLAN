          ...
          <div className="grid grid-cols-3 gap-x-7 gap-y-5">
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(num => (
              <button
                ...
                className="surface w-16 h-16 rounded-full text-2xl font-medium text-[var(--ink)] active:scale-90 transition-transform"
              >
                {num}
              </button>
            ))}
            <div />
            <button onClick={() => handlePinPress('0')} className="surface w-16 h-16 rounded-full text-2xl font-medium text-[var(--ink)] active:scale-90 transition-transform">0</button>
