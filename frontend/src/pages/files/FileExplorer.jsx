...
const EntryMenu = ({ onCopy, onCut, onRename, onDelete }) => {
  ...
  return (
    <div ref={ref} className="relative" onClick={(e) => e.stopPropagation()}>
      ...
      {open && (
        <div className="glass-strong absolute right-0 top-full mt-1 z-20 w-40 rounded-xl p-1 animate-sheet-in">
          {[
  ...
  return (
    <div className="w-full h-full flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {newFolderOpen && (
          <div className="glass rounded-2xl p-4 m-4 mb-0 flex items-center gap-3 flex-shrink-0">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
                {ROOT_FOLDERS.map((f) => (
                  <button
                    ...
                    className="glass rounded-2xl p-4 text-left hover:brightness-125 active:scale-[0.98] transition-all flex items-center gap-3"
                  >
